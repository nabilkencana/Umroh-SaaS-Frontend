...
import {
  ...
  StarIcon,
  ArrowRightIcon,
  PhoneIcon, // Ganti HeadsetIcon dengan PhoneIcon
  WifiIcon, // Alternatif untuk Headset
  ChatBubbleLeftRightIcon, // Alternatif lain untuk Support
...
const destinations = [
  {
    ...
    description: 'Kota suci yang menjadi kiblat doa dan harapan jutaan umat Muslim dari seluruh penjuru dunia.',
    stats: [
  ...
  },
  {
    ...
    description: 'Masjid Nabawi adalah tempat peristirahatan terakhir Nabi Muhammad SAW dan pusat spiritual Islam.',
    stats: [
...
// Ganti stats dengan icon Heroicons yang benar
const stats = [
  {
    value: '99.9%',
    label: 'Uptime',
  ...
  },
  {
    ...
    change: 'Always',
    positive: true,
    icon: ChatBubbleLeftRightIcon // Ganti HeadsetIcon dengan ChatBubbleLeftRightIcon
  },
  {
    value: '1.2M+',
    label: 'Jamaah',
...
// Tambahkan stats counter dengan icon
const counterStats = [
  {
    value: '500+',
    label: 'Travel Agents',
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 py-20 text-white">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            {/* Stats Card - Dengan icon Heroicons */}
            <motion.div
                    ...
                    {stats.map((stat, index) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="inline-block mt-2 text-xs px-2 py-1 rounded-full bg-emerald-500/30 text-emerald-200 flex items-center gap-1">
        ...
        <div className="relative container mx-auto px-4 text-center">
          ...
          >
            ...
            <div className="flex flex-wrap justify-center gap-6">
              <Link
                href="/register"
                className="group relative overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-500 to-teal-500 px-12 py-6 text-xl font-bold text-white transition-all hover:shadow-2xl hover:scale-105 flex items-center gap-2"
              >
              ...
              <Link
                href="/contact"
                className="group rounded-2xl border-2 border-white px-12 py-6 text-xl font-bold text-white transition-all hover:bg-white/10 hover:scale-105 flex items-center gap-2"
              >
